...
- `public/catalog/create-order-flow.png`: cópia de `.codex/slide-agenda-eventcatalog/captures/create-order-flow-clean.png`, 1600×600. O original registra o fluxo CreateOrder → decisão → OrderCreated → Inventory/Notifications. Nenhuma relação foi alterada. As cores do EventCatalog permanecem na captura.
